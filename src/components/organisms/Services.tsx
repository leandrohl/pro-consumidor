...
export default function Services() {
  return (
    <section className="bg-primary flex flex-col items-center py-16">
      <h3 className="font-dinamica text-white text-5xl text-center">Direito do consumidor sem burocracia e com transparência</h3>
      <p className="text-white text-xl pb-16 pt-2 text-center">Nós podemos te ajudar em casos de:</p>
